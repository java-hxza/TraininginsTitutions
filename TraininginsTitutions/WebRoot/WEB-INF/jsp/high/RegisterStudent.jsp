											...
											<div class="row">
												...
												<form novalidate>
														...
														<div class="col-3">
															<div class="form-group">
																<label>手机号</label> <input type="text"
																	class="form-control telephone" data-toggle="input-mask"
													...
													<div class="row">
														...
														<div class="col-3 classType1">
															<div class="form-group">
																<label for="billing-zip-postal">班级类别</label> <select
																	class="form-control classType">
																	<option value="0">---请选择---</option>
																	<c:forEach items="${classType }" var="c">
																		<option value="${c.classTypeId }"
																			name="${c.classTypeTime }">${c.classTypeName }</option>
																	</c:forEach>
																</select>
															</div>
														</div>
														<div class="col-3 classes1">
															<div class="form-group">
														...
														<div class="col-3">
															<div class="form-group mb-3">
																<label for="example-number">手续费</label> <input
																	class="form-control serviceCharges" id="example-number"
													...
													<div class="row charge" style="display: none;">
														...
														<div class="col-3 departmentofpediatricsIds2Div">
															<div class="form-group mb-3">
																<label for="example-select">课程名称</label> <input
														...
														<div class="col-3 giftNumber2Div">
															<div class="form-group">
																<label for="billing-last-name">赠品数量</label> <input
